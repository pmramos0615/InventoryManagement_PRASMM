...
namespace InventoryManagement_PRASMM.Models
{
    public class ProductSubCategory
    {
        ...
        public static ProductSubCategory GetById(int id)
        {
            var dal = new ProductSubCategoryDAL();
            var instance = new ProductSubCategory();
            instance.Bind(dal.GetById(id));
            return instance;
        }
        public static List<ProductSubCategory> GetAll()
        {
            var dal = new ProductSubCategoryDAL();
            var collection = new List<ProductSubCategory>();
        ...
        public bool Save()
        {
            ...
            string message = "";
            int ret = dal.Save(this.ID, this.CategoryID, this.Code, this.Name, this.Description, this.Discontinued, this.DiscontinuedBy, this.DateDiscontinued, this.CreatedBy, this.DateCreated, this.ModifiedBy, this.DateModified, out message);
