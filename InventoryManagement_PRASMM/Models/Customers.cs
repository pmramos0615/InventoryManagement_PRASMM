...
namespace InventoryManagement_PRASMM.Models
{
    public class Customers
    {
        ...
        {
            var dal = new CustomersDAL();
            var collection = new List<Customers>();
        ...
        public bool Save()
        {
            ...
            string message = "";
            int ret = dal.Save(this.ID, this.StoreID, this.Name, this.Address1, this.Address2, this.TermID, this.ContactNo, this.ContactPerson, this.EmailAddress, this.Description, this.VATRef, this.TaxTypeID, this.Discontinued, this.DiscontinuedBy, this.DateDiscontinued, this.CreatedBy, this.DateCreated, this.ModifiedBy, this.DateModified, out message);
