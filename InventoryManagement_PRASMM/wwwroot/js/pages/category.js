$(document).ready(function () {
        ...
        "columns": [
            ...
            { "data": "createdBy", "autoWidth": true }, //index 0
            {
                "data": "id", "width": "100px", "render": function (data) {
                    return '<a class="me-3 btnEdit" href="/Category/Details/' + data + '"><img src="img/icons/edit.svg" alt="img"></a>';
                }
            }
        ],
    ...
    $("#btnDelete").click(function () {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: "You want to delete this category record!",
            type: "warning",
            showCancelButton: !0,
            ...
            Swal.fire({
                type: "success",
                title: "Deleted!",
                text: "Your category record has been deleted.",
